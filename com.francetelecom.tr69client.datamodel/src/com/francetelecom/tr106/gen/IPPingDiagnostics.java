...
public class IPPingDiagnostics  {
    ...
    */  
    public final com.francetelecom.admindm.model.Parameter
                     createMinimumResponseTime() throws Fault {
    	com.francetelecom.admindm.model.Parameter param;
        param = data.createOrRetrieveParameter(basePath + "MinimumResponseTime");
        param.setNotification(0);
        param.setStorageMode(StorageMode.DM_ONLY);
    ...
    */  
    public final com.francetelecom.admindm.model.Parameter
                     createFailureCount() throws Fault {
    	com.francetelecom.admindm.model.Parameter param;
    ...
    */  
    public final com.francetelecom.admindm.model.Parameter
                     createAverageResponseTime() throws Fault {
    	com.francetelecom.admindm.model.Parameter param;
        param = data.createOrRetrieveParameter(basePath + "AverageResponseTime");
        param.setNotification(0);
        param.setStorageMode(StorageMode.DM_ONLY);
        param.setActiveNotificationDenied(true);
        param.setType(ParameterType.UINT);
    ...
    */  
    public final com.francetelecom.admindm.model.Parameter
                     createMaximumResponseTime() throws Fault {
    	com.francetelecom.admindm.model.Parameter param;
        param = data.createOrRetrieveParameter(basePath + "MaximumResponseTime");
        param.setNotification(0);
        param.setStorageMode(StorageMode.DM_ONLY);
        param.setActiveNotificationDenied(true);
        param.setType(ParameterType.UINT);
