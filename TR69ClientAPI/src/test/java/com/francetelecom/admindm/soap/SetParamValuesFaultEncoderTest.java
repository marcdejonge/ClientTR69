...
public class SetParamValuesFaultEncoderTest extends TestCase {
    private static final String INDENT_OUTPUT = "http://xmlpull.org/v1/doc/features.html#indent-output";
    public void testEncode() throws Exception {
        TestUtil.TRACE(this);
        SetParamValuesFaultEncoder encoder = new SetParamValuesFaultEncoder();
        IParameterData data = new ParameterData();
        Element e = encoder.encode(new SetParamValuesFault("test", 9002,
                "error"));
