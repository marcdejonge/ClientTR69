...
public final class Activator implements BundleActivator {
    ...
    public void start(final BundleContext context) throws Exception {
        ...
        if (rpcMethodMngServiceRef != null) {
            ...
            rpcMng.registerRPCEncoder("DeleteObjectResponse",
                    new DeleteObjectResponseEncoder());
            rpcMng.registerRPCDecoder("DeleteObject",
                    new DeleteObjectDecoder());
            Log.info("Start RPC Method DeleteObject");
        } else {
            Log.error("Unable tp start DeleteObject: "
